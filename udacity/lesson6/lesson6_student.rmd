...
ggplot(data = diamonds, aes(x = carat, y = price)) +
  ...
  ylim(c(0, quantile(diamonds$price, 0.99))) + 
    geom_point(fill = I('#F79428'), color = I('black'), shape = 21) 
...
p1 <- ggplot(data = diamonds, aes(x = price)) + 
  geom_histogram(fill = '#099DD9', binwidth = 100) + 
  ggtitle('price')

p2 <- ggplot(data = diamonds, aes(x = price)) + 
  geom_histogram(fill = '#f79420', binwidth = 0.01) + 
  scale_x_log10() +
  ggtitle('price(log10)')
...
ggplot(data = diamonds, aes(x = price)) + 
  geom_histogram(fill = '#099DD9', binwidth=1000) + 
  ggtitle('price') + 
  facet_wrap(~cut)
...
ggplot(aes(carat, price), data = diamonds) + 
  geom_point(alpha = 1/10, position = 'jitter', size = 0.75) + 
  scale_x_continuous(trans = cuberoot_trans(), limits = c(0.2, 3),
                     breaks = c(0.2, 0.5, 1, 2, 3)) + 
  scale_y_continuous(trans = log10_trans(), limits = c(350, 15000),
                     breaks = c(350, 1000, 5000, 10000, 15000)) +
...
scale_color_brewer() #配色方案palette
scale_fill_brewer() #配色方案palette
...
ggplot(aes(x = carat, y = price), data = diamonds) + 
  geom_point(aes(color = clarity), alpha = 0.5, size = 0.5, position = 'jitter') +
